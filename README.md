...
### Objetivo do projeto:
Simular um sistema bancário, permitindo ao usuário realizar várias operações, como por exemplo, criar conta, atualizar conta, deletar conta, bem como efetuar operações de depósito, saque, transferência e emissão de extrato.

### Esse repositório contém:
- index.js: realiza a comunicação entre os arquivos e o servidor.
- roteador.js: organiza as rotas dos endpoints.
- controle.js: dospõe das funcionaldiades porpostas no desafio.
- bancodedados.js: dispõe de todos os dados de entrada e saída do projeto.

### Executando o projeto:
Com o projeto aberto dentro do VSCODE, deve-se instalar:
- npm install express
- npm install utils-playground
- npm install -D nodemon

![tela 1](https://github.com/cubos-academy/desafio-backend-modulo-02-sistema-bancario-b2b-ifood-t11/assets/47258064/d1a58f26-8711-43f5-ba04-be0d78198f06)
![tela 2](https://github.com/cubos-academy/desafio-backend-modulo-02-sistema-bancario-b2b-ifood-t11/assets/47258064/0def4b98-2dc4-43ad-a642-ed4d14af06fa)
![tela 3](https://github.com/cubos-academy/desafio-backend-modulo-02-sistema-bancario-b2b-ifood-t11/assets/47258064/a20892ed-212c-41bc-87c1-63d4359cbd8d)
![tela 4](https://github.com/cubos-academy/desafio-backend-modulo-02-sistema-bancario-b2b-ifood-t11/assets/47258064/4b7d046a-3b2d-4a7e-be70-a81a1781e6a7)
